...
public class LabTestBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edPhoneNum =findViewById(R.id.editTextLTBContactNum);
        ...
        btnBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.addOrder(username,edname.getText().toString(),edAddress.getText().toString(),edPhoneNum.getText().toString(),Integer.parseInt(edPin.getText().toString()),date.toString(),time.toString(),Float.parseFloat(price[1].toString()),"lab");
